<x-layout title="Contact">
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div aria-hidden="true" class="absolute inset-x-0 top-30 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-20">
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-2 text-lg/8 text-gray-600">This is only markup, so submitting the form will have no effect.</p>
        </div>

        <form action="{{ route('contact') }}" method="GET" class="mx-auto mt-16 max-w-xl sm:mt-20">
