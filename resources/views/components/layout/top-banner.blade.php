<div {{ $attributes->class(['relative', 'z-10', 'isolate', 'flex', 'items-center', 'gap-x-6', 'overflow-hidden', 'bg-gray-50', 'px-6', 'py-2.5', 'sm:px-3.5', 'sm:before:flex-1']) }}>
    ...
    <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p class="text-sm/6 font-medium text-gray-900">
            The UI components are designed and developed by the creators of Tailwind CSS.
        </p>

        <a href="https://tailwindcss.com/plus" class="flex-none rounded-full bg-gray-900 px-3.5 py-1 text-sm font-semibold text-white shadow-xs hover:bg-gray-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900" target="_blank">
